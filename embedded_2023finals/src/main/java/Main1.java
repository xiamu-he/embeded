...
//                if (RBusinessTotal[t].routeNum != 1)
//                    continue;
//                if (!RBusinessTotal[t].isProcess) {
//                    int startNode = RBusinessTotal[t].startNode;
//                    int endNode = RBusinessTotal[t].endNode;
//                    // 获得业务在通道p中不需要加边的最短路径
//                    if (p == 0) {
//                        minTrack = getPath1(startNode, endNode, p, RBusinessTotal[t].business_id);
//                    }
...
//        for (int i = 0; i < R; i++) {
//            int start = RBusinessTotal[i].startNode;
//            int end = RBusinessTotal[i].endNode;
//
